...
1987年に出た最初のl [Macintosh Human Interface Guidelines](https://archive.org/details/applehumaninterf00appl) では、「見て指差す（覚えてタイプするではなく）」方式を推奨している。それがあたかも二択問題であるかのように。
